  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
       ...
       <td>
              <a href="<?php echo e(url('/edit_product/'.$row->id)); ?>" class="active" ui-toggle-class=""><i class="fas fa-edit"> </a></i><a href="<?php echo e(url('/delete/'.$row->id)); ?>" onclick="return confirm('Are you want to delete category?')"> <i class="fa fa-times text-danger text"></i></a>
            </td>
       </tr>
...
<?php /**PATH C:\Users\votan\Desktop\x\resources\views\Product\list_product.blade.php ENDPATH**/ ?>