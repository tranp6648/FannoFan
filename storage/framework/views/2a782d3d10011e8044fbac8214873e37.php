...
<body class="main-layout">
   ...
   <footer class="page-footer font-small unique-color-dark ">
      ...
      <!-- Copyright -->
      <img src="<?php echo e(asset('images/back-to-top-button.png')); ?>" alt="" onclick="scroll_to_top()" id="scroll_top" style="position: fixed; bottom: 0; right: 3vw;" width="3">
   </footer>
   <!-- end footer -->
   <!-- Javascript files-->
...
</html><?php /**PATH C:\Users\votan\Desktop\project-FANoFAN\resources\views/layouts/template.blade.php ENDPATH**/ ?>