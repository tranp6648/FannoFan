                        ...
                        <?php if(Session::has('success')): ?>
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="" class="form-control" style="resize: none;"  rows="8" placeholder="Enter Product Description"></textarea>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php if(Session::has('model')): ?>
                                    <script>
                                        toastr.success("<?php echo e(session('model')); ?>")
                                    </script>

                                    <?php endif; ?>
        <form action="/bonus_photo" enctype="multipart/form-data" method="post">
            <?php echo csrf_field(); ?>
        <div class="form-group">
                                    <label for="exampleInputEmail1">Name photo</label>
                                    <input type="file" class="form-control" id="fileImg" name="fileImg"  placeholder="Enter name category">
                                    <div class="preview">
        <img src="https://cdn.vectorstock.com/i/preview-1x/65/30/default-image-icon-missing-picture-page-vector-40546530.jpg" class="image" alt="Preview" id="img" style="width: 100%; height: 100%;">
    </div>
                                </div>
...
<?php /**PATH C:\Users\votan\Desktop\x\resources\views\Product\add_product.blade.php ENDPATH**/ ?>