...
<body class="main-layout">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark scrolling-navbar fixed-top" id="navbar" style="padding-right: 3%">
        ...
        <div class="collapse navbar-collapse mt-lg-0 mt-md-3 mt-sm-4" id="basicExampleNav">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active  dropdown px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto">
                    <a class="nav-link dropdown-toggle categories-link waves-effect waves-light" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/upload/{{$avatar->avatar}}" alt="" width="30" style="border-radius: 50%"></a>
    ...
    <footer class="page-footer font-small unique-color-dark ">
        ...
        <!-- Copyright -->
        <img src="{{asset('images/back-to-top-button.png')}}" alt="" onclick="scroll_to_top()" id="scroll_top" style="position: fixed; bottom: 3vh; right: 1vw; width: 3rem; display: none">
    </footer>
    <!-- end footer -->
    <!-- Javascript files-->
