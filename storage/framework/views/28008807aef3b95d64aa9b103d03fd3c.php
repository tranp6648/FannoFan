    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="top-nav clearfix">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img src="/public/upload/<?php echo e($list_photo->value); ?>" alt="">
                    ...
                    <div class="market-update-block clr-block-2">
                        ...
                        <div class="col-md-8 market-update-left">
                            <table class="table">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $last; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php /**PATH C:\Users\Phong\Documents\Zalo Received Files\x25\resources\views/admin/admin.blade.php ENDPATH**/ ?>