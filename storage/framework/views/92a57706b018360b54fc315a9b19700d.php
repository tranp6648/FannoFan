    ...
    <div class="container px-5">
        <div class="row  gx-4">
            <div class="col-lg-3 col-md-6 col-sm-12 mx-auto addresses mt-sm-4 mt-lg-0 mt-md-0">
                <div class="p-2  ">
                    <div class="icon-holder"><i class="fas fa-map-marker-alt text-center location" aria-hidden="true" style="visibility: visible;font-size: 25px;color: aliceblue;"></i>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mx-auto addresses mt-sm-4 mt-lg-0 mt-md-0">
                <div class="p-2  ">
                    <div class="icon-holder"><i class="fas fa-phone-alt text-center " aria-hidden="true" style="visibility: visible;font-size: 25px;color: aliceblue;"></i>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mx-auto addresses mt-lg-0 mt-md-4 mt-sm-4">
                <div class="p-2  ">
                    <div class="icon-holder"><i class="fas fa-mail-bulk text-center " aria-hidden="true" style="visibility: visible;font-size: 25px;color: aliceblue;"></i>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mx-auto addresses mt-lg-0 mt-md-4 mt-sm-4">
                <div class="p-2  ">
                    <div class="icon-holder"><i class="fas fa-globe-africa text-center location" aria-hidden="true" style="visibility: visible;font-size: 25px;color: aliceblue;"></i>
                    </div>
            ...
            <div class="col-md-6 col-xl-4" style="color: white;">
                <div>
                    ...
                    <form class="p-3 p-xl-4" method="post" action="/contact_post">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="message">Message</label><textarea class="form-control" id="message" name="message" rows="6"></textarea>
                        </div>
                        <div class="mb-3">
