...
<body class="main-layout">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark scrolling-navbar fixed-top">
      ...
      <div class="col-md-3">
         <div class="search">
            <form action="http://127.0.0.1:8000/sreach">
         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active  dropdown px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto">
               ...
               <div class="dropdown-menu dropdown-primary  mt-lg-3" style="background-color: #6c757d;" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item ceiling-fans-link waves-effect waves-light" href="/categories_ceiling">Ceiling Fans</a>
                  <a class="dropdown-item table-fans-link waves-effect waves-light" href="/categories_table">Table Fans</a>
                  <a class="dropdown-item standing-fans-link waves-effect waves-light" href="/categories_standing">Standing Fans</a>
                  <a class="dropdown-item exhaust-fans-link waves-effect waves-light" href="/categories_exhaust">Exhuast Fans</a>
               </div>
            </li>
            <li class="nav-item active px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto">
            ...
            <li class="nav-item active  px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto">
               ...
               <li class="nav-item active px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto" style="font-size: 10px;margin: 0;padding:0 !important;">
               ...
               <?php if(Session::get('value')): ?>
                 <img src="/public/upload/<?php echo e($list_photo->value); ?>" width="43" height="30" alt="">
                 <?php else: ?>

                 <img src="<?php echo e(asset('/public/upload/user.png')); ?>" alt="" style="" width="43" height="30">
                  <?php endif; ?>
                  <li class="nav-item active px-lg-2 py-lg-0 py-md-1 py-sm-1 text-center  mx-auto" style="font-size: 10px;margin: 0;padding:0 !important;">
                  <a class="nav-link home-link  waves-effect waves-light" href="logout">logout </a>
   ...
   <header class="img-fluid" style="padding: 13% 0px;">
   </header>
...
</html><?php /**PATH C:\Users\Phong\Documents\x\resources\views/layouts/template.blade.php ENDPATH**/ ?>