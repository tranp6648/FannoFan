                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped b-t b-light">
                        ...
                        <tr id="product_ids<?php echo e($row->id_product); ?>">
                            ...
                            <td>
                                <a href="<?php echo e(url('/edit_product/'.$row->id_product)); ?>" class="active" ui-toggle-class=""><i class="fas fa-edit"> </i>
                                </a>
                                <a href="<?php echo e(url('/delete_product/'.$row->id_product)); ?>" onclick="return confirm('Are you want to delete product?')">
